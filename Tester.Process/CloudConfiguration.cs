...
namespace AlertTester.Process
{
    ...
    /// </summary>
    public class CloudConfiguration : IConfiguration
    {
        ...
        public void ReadConfig()
        {
            ...
            if (CloudConfigurationManager.GetSetting("AAClientID") != null)
                LogAnalyticsProviderConfig.loganalyClientId = CloudConfigurationManager.GetSetting("AAClientID");
